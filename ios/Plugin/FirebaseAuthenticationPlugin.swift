...
public class FirebaseAuthenticationPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    public let pluginMethods: [CAPPluginMethod] = [
        ...
        CAPPluginMethod(name: "getMultiFactorResolverHints", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "verifyPhoneNumberForMultiFactor", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "resolveMultiFactorSignIn", returnType: CAPPluginReturnPromise),
    ...
    public let errorMultiFactorResolverMissing =
    ...
    public let errorMultiFactorHintInvalid = "The selected multi-factor hint is invalid or is not a phone second factor."
    ...
    @objc func getMultiFactorResolverHints(_ call: CAPPluginCall) {
        implementation?.getMultiFactorResolverHints(call)
    }

    @objc func verifyPhoneNumberForMultiFactor(_ call: CAPPluginCall) {
        implementation?.verifyPhoneNumberForMultiFactor(call)
    }

    @objc func resolveMultiFactorSignIn(_ call: CAPPluginCall) {
        implementation?.resolveMultiFactorSignIn(call)
    }
