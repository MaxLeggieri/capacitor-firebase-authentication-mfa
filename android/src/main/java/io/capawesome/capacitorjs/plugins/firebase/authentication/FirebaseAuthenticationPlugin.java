...
public class FirebaseAuthenticationPlugin extends Plugin {
    ...
    public static final String ERROR_MULTI_FACTOR_RESOLVER_MISSING =
    ...
    public static final String ERROR_MULTI_FACTOR_HINT_INVALID = "The selected multi-factor hint is invalid or is not a phone second factor.";
    ...
    @PluginMethod
    public void getMultiFactorResolverHints(PluginCall call) {
        try {
    ...
    @PluginMethod
    public void verifyPhoneNumberForMultiFactor(PluginCall call) {
        try {
    ...
    @PluginMethod
    public void resolveMultiFactorSignIn(PluginCall call) {
        try {
