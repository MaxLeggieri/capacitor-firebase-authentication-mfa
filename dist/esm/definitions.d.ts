 ...
 * @since 7.3.1
 */
export interface GetMultiFactorResolverHintsResult {
    /**
     * The enrolled second factors of the user associated with the pending
...
export interface MultiFactorInfo {
    ...
    uid: string;
    /**
     * The user-provided display name of the enrolled second factor.
     *
     * @since 7.3.1
     */
    displayName?: string;
    /**
     * The factor identifier (e.g. `phone`).
     *
     * @since 7.3.1
     */
    factorId?: string;
    /**
     * The obfuscated phone number associated with a phone second factor.
     *
     * @since 7.3.1
     */
    phoneNumber?: string;
 ...
 * @since 7.3.1
 */
export interface VerifyPhoneNumberForMultiFactorOptions {
    /**
     * The index of the second factor hint (see {@link GetMultiFactorResolverHintsResult.hints})
     * to send the verification code to.
     *
     * @default 0
     * @since 7.3.1
     */
 ...
 * @since 7.3.1
 */
export interface VerifyPhoneNumberForMultiFactorResult {
    /**
     * The verification ID to be used together with the SMS code in
 ...
 * @since 7.3.1
 */
export interface ResolveMultiFactorSignInOptions {
    /**
     * The verification ID received from `verifyPhoneNumberForMultiFactor(...)`.
     *
     * @since 7.3.1
     */
    verificationId: string;
