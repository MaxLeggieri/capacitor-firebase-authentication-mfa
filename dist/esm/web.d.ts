...
export declare class FirebaseAuthenticationWeb extends WebPlugin implements FirebaseAuthenticationPlugin {
    ...
    static readonly ERROR_MULTI_FACTOR_RESOLVER_MISSING = "No multi-factor resolver was found. A sign-in attempt that fails with the auth/multi-factor-auth-required error code must be made first.";
    static readonly ERROR_NO_RESOLVER_FOR_VERIFICATION_ID = "No multi-factor resolver with this verification id was found.";
     ...
     */
    private runSignIn;
    private captureMultiFactorError;
